...
const CONTRACT_ADDRESSES: ContractAddresses = {
  avalancheRushCore: process.env.REACT_APP_AVALANCHE_RUSH_CORE_ADDRESS || '0x742d35Cc5A5E2a9E1aB8d8C6E6E9F4A5B8D35a9',
  reactiveQuestEngine: process.env.REACT_APP_REACTIVE_QUEST_ENGINE_ADDRESS || '0x6a1d5C5E3A5E2a9E1aB8d8C6E6E9F4A5B8D35d2',
  educationalNFT: process.env.REACT_APP_EDUCATIONAL_NFT_ADDRESS || '0x7b2d5C5E3A5E2a9E1aB8d8C6E6E9F4A5B8D35e3',
  rushToken: process.env.REACT_APP_RUSH_TOKEN_ADDRESS || '0x8a1d5C5E3A5E2a9E1aB8d8C6E6E9F4A5B8D35b0',
  mockDEX: process.env.REACT_APP_MOCK_DEX_ADDRESS || '0x9b2d5C5E3A5E2a9E1aB8d8C6E6E9F4A5B8D35c1'
};
